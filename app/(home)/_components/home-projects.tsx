...
const HomeProjects = () => {
  return (
    <div
      id="projects"
      className="w-full min-h-screen py-36 gap-12 flex flex-col z-10"
    >
      <section className="max-w-7xl mx-auto w-full px-6 flex flex-col gap-4">
        ...
        <span className="text-base font-light text-muted-foreground">
          ...
          для лучшего пользовательского опыта, рекомендуется создать аккаунт
          Darkmaterial, один аккаунт на все сервисы.
        </span>
      </section>
